<%
	...
	/*Verifica se sess�o log � true
		Se true
			Valida se o usu�rio � admin
				Se true
					Redireciona para p�gina de admin
				Se false
					Exibe a p�gina do mapa
		Se false
			Redireciona para index institucional
	*/
  ...
  <div class="modal-body">
    ...
    <form id="formulario" method="post" action="">
      ...
      <label for="senha">Senha:</label>
         ...
         <input type="text" id="imagemAtual">
    </form>
    
    <input type="button" id="eventoVerifica" value="Verifica Carregamento">
  </div>
  ...
  <script type="text/javascript">
	$(document).ready(function(){
	 $('#imagem').on('change',function(){
		 $('#retornoImg').html('<img src="img/loading.gif" id="imagemPerfil" alt="Enviando..."/>');
		 /* Efetua o Upload */
		 	$('#formularioImagem').ajaxForm({
			target:'#retornoImg' // o upload sera na div retornoImg
		 	}).submit();
			
				nomeImagem = $('#nomeOculto').val();
				$('#imagemAtual').val(nomeImagem);
